...
I don't know how true this is but I learned that hooks we're named because they grant a developer the ability to attach their own code (like bait) and hook into external functionality for a desired result.

There have been books written about the concepts surrounding the idea of hooking and frankly we don't need to get too in-depth here.
