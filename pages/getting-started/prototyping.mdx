...
<Image src="/../public/prototypes/paper-prototyping.jpeg" width={600} height={50} quality={100} style={{height:'auto', width:'80%'}} alt="Design System for tutorial project"/>

**Also This**

<Image src="/../public/prototypes/hi-fi-prototype.png" width={600} height={50} quality={100} style={{height:'auto', width:'80%'}} alt="Design System for tutorial project"/>
