...
<Image src="/prototypes/paper-prototyping.jpeg" width={600} height={50} quality={100} style={{height:'auto', width:'80%'}} alt="Low fidelity Paper prototype"/>

**Also This**

<Image src="/prototypes/hi-fi-prototype.png" width={600} height={50} quality={100} style={{height:'auto', width:'80%'}} alt="High fidelity prototype in Figma"/>
